  ...
  Widget build(BuildContext context) {
    ...
    return  Scaffold(
      ...
      if (!snapshot1.hasData)
        ...
        UserMe user = UserMe.fromMap(snapshot1.data!.data()! as Map<String, dynamic>);
        {
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      // SizedBox(width: 10,),
                      CircleAvatar(
                        radius: 30.0, // set the radius of the avatar
                        backgroundImage: AssetImage('assets/images/logo.png'), // set the image for the avatar
                      ),
                    ],
                  ),
                ),
                  ...
                  builder: (context, snapshot) {
                    ...
                    final products = snapshot.data!.docs
                      ...
                      if (_tabController.index == 0) {
                        ...
                        return  product.catygorie == "Pizza";// show pizza products
                      } else if (_tabController.index == 2) {
                        return product.catygorie == "Burgers"; // show burger products
                      } else {
